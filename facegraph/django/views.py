...
class CallbackView(object):
    ...
    def access_token_url(self):
        ...
        #url.add_query_param(u'code', self.request.GET['code'])
        #url.add_query_param(u'client_id', self.client_id())
        #url.add_query_param(u'client_secret',  self.client_secret())
        #url.add_query_param(u'redirect_uri', self.redirect_uri())
